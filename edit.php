...
{	
	...
	if(empty($name) || empty($firstname) || empty($email) || empty($tel) || empty($login)) {	
		...
		if(empty($firstname)) {
			echo "<font color='red'> Le prénom est vide.</font><br/>";
		}
		...
		if(empty($tel)) {
			echo "<font color='red'>Le numéro de telephone est vide.</font><br/>";
		}
		if(empty($login)) {
			echo "<font color='red'>Le login est vide.</font><br/>";
		}	

	} else {	
		//updating the table
		$sql = "UPDATE user SET name=:name, firstname=:firstname, email=:email, tel=:tel , login=:login WHERE id=:id";
...
<!-- Mirrored from demo.geekslabs.com/materialize/v3.1/page-blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Jan 2017 16:38:39 GMT -->
<head>
...
<body>
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><!--a href="index-2.html" class="brand-logo darken-1"><img src="images/logot.png" alt="materialize logo" class="circle responsive-img valign profile-image-login"></a--> <span class="logo-text">Materialize</span></h1></li>
                    </ul>
                    ...
                    <ul class="right hide-on-med-and-down">
                        <li><a href="deconnexion.php" class="waves-effect waves-block waves-light translation-button"  data-activates="translation-dropdown">Déconnexion</a>
                        </li>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold">
            <div class="row">
                <img src="images/logot.png" alt="materialize logo" class="circle responsive-img valign profile-image-login">
                <div class="col col s4 m4 l4">
                    <!--img src="images/avatar.jpg" alt="" class="circle responsive-img valign profile-image"-->
                </div>
                <div class="col col s8 m8 l8">
                    <ul id="profile-dropdown" class="dropdown-content">
                        <li><a href="user.php"><i class="mdi-action-face-unlock"></i> Profil</a>
                        </li>
                        <!--li><a href="#"><i class="mdi-action-settings"></i> Parametrage</a>
                        </li-->
                        <li><a href="#"><i class="mdi-communication-live-help"></i>Aide</a>
                        </li>
                        <!--li class="divider"></li>
                        <li><a href="#"><i class="mdi-action-lock-outline"></i> Lock</a>
                        </li-->
                        <!--li><a href="#"><i class="mdi-hardware-keyboard-tab"></i> Deconnexion</a>
                        </li-->
                    </ul>
                    <a class="btn-flat dropdown-button waves-effect  black-text profile-btn" href="user.php" data-activates="profile-dropdown"><?php  echo 'Bienvenue '.$_SESSION['login']; ?><i class="mdi-navigation-arrow-drop-down right"></i></a>
                   
                   
                </div>
            </div>
            </li>
           <a href="page-blank.php" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i>   Accueil</a>
            </li>
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-view-carousel"></i> Graphes</a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="country.php">graphe</a>
                                </li>
      ...
      <section id="content">
        <div class="container">
          <div class="section">
			<a href="page-blank.php">Accueil</a>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2017 <span> <!--a class="grey-text text-lighten-4" href="http://themeforest.net/user/geekslabs/portfolio?ref=geekslabs" target="_blank">GeeksLabs</a> All rights reserved.</span>
