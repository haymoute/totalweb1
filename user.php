...
$result = $dbConn->query("SELECT * FROM user  Where login='$login'");
...
<body>
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        <div class="container">
          <div class="section">
   <a href="add.html">Ajouter un nouveau utilisateur</a><br/><br/>
  ...
  while($row = $result->fetch(PDO::FETCH_ASSOC)) {    
    ...
    echo "<td><a href=\"edit.php?id=$row[id]\">Modifier</a> | <a href=\"delete.php?id=$row[id]\" onClick=\"return confirm('Etes vous sure de vouloire suprimer?')\">Supprimer</a></td>";   
  }
  ?>
  </table>
